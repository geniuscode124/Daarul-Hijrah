    ...
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-[#F4F9F6] p-4 text-foreground relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[480px]">
         ...
         <div className="mb-8 flex flex-col items-center justify-center">
            ...
            <h1 className="text-center font-serif text-3xl font-bold text-[#0F3D2E]">Set New Password</h1>
            <p className="mt-2 text-center text-sm text-gray-500">Pick a strong new password for your account</p>
         </div>

         {/* Reset Password Card */}
         <div className="rounded-2xl bg-white p-8 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] sm:p-10">
            <Suspense fallback={<div className="flex justify-center p-8"><Loader2 className="h-8 w-8 animate-spin text-[#0F3D2E]" /></div>}>
              <ResetPasswordForm />
            </Suspense>
         </div>
         ...
         <div className="mt-8 text-center">
             <p className="text-sm text-gray-500">
                Remembered your password? <Link href="/login" className="font-bold text-[#0F3D2E] hover:underline">Log In</Link>
             </p>
         </div>
