...
export function SignupForm() {
  ...
  async function handleGoogleSignUp() {
    ...
    try {
      ...
      // For sign up, we use the same signIn.social method as it handles both sign up and sign in
    ...
    <div className="w-full max-w-lg space-y-8">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 pt-4">
                    ...
                    {field.value.length > 0 && (
                      <div className="space-y-3">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Must contain at least 8 characters, one symbol, one
          ...
          <Button
            type="submit"
            className="h-12 w-full bg-primary font-semibold hover:bg-primary/90 cursor-pointer"
